...
- [Kerfislýsingar](handbook/technical-overview/auth/README.md)
  - [System](handbook/technical-overview/auth/system/README.md)
    - [Service Provider Manual](handbook/technical-overview/auth/system/service-provider-manual/README.md)
      ...
      - [Incidents](handbook/technical-overview/auth/system/service-provider-manual/incidents.md)
      - [Intervention by Code Change](handbook/technical-overview/auth/system/service-provider-manual/intervention-by-code-change.md)
      - [Trouble Shooting](handbook/technical-overview/auth/system/service-provider-manual/trouble-shooting.md)
    - [System Manual](handbook/technical-overview/auth/system/system-manual/README.md)
      - [Introduction](handbook/technical-overview/auth/system/system-manual/introduction.md)
      - [Service Provider’s Role](handbook/technical-overview/auth/system/system-manual/service-provider-role.md)
...
- [Application](libs/application/README.md)
  - [API Template Utils](libs/application/api-template-utils/README.md)
  ...
  - [Template Loader](libs/application/template-loader/README.md)
    - [Children Domicile Transfer Template](libs/application/templates/children-domicile-transfer/README.md)
